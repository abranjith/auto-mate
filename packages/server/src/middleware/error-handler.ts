...
const INGESTION_STATUS: Readonly<Record<string, number>> = {
  ...
  // Verification, approval, run, and review (FEAT-107).
  [ERROR_CODES.VERIFICATION_NOT_FOUND]: 404,
  [ERROR_CODES.RUN_NOT_FOUND]: 404,
  [ERROR_CODES.VERIFICATION_STALE]: 409,
  [ERROR_CODES.VERIFICATION_BLOCKED]: 409,
  [ERROR_CODES.EXECUTION_NOT_APPROVED]: 409,
  [ERROR_CODES.APPROVAL_INTENT_MISMATCH]: 409,
  [ERROR_CODES.APPROVAL_STALE]: 409,
  [ERROR_CODES.REVIEW_NOT_PENDING]: 409,
  [ERROR_CODES.INPUT_COPY_MISMATCH]: 409,
  [ERROR_CODES.RUN_OUTPUT_MISSING]: 422,
  [ERROR_CODES.CHECKER_UNAVAILABLE]: 503,
};
